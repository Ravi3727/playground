...
const HomeCards = ({ color, obj }) => {
    return (
        <div style={{ borderTopColor: color }} className={`w-[307px] h-[217px] border-t-3 $ border-x-2 border-x-gray-200 py-3 px-3 rounded-2xl 0 flex flex-col justify-between gap-4`}>
            <div>
