...
export const postDepartment = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(500, `Error Occurred while creating department : ${err.message}`);
  }
});
...
export const getDepartment = asyncHandler(async (req, res) => {
  try {
    ...
    throw new ApiError(500, `Error Occurred while fetching department : ${error.message}`);
  }
});
...
export const getDepartmentById = asyncHandler(async (req, res) => {
  try {
    ...
    throw new ApiError(500, `Error Occurred while fetching department : ${err.message}`);
  }
});
...
export const updateDepartment = asyncHandler(async (req, res) => {
  try {
    ...
    throw new ApiError(500, `Error Occurred while updating Department : ${err.message}`);
  }
});